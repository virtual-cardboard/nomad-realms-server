...
public class NomadRealmsDatabase {
	...
	public void connect() {
		if (connected) {
			...
			dbSource.setUrl("jdbc:postgresql://free-tier11.gcp-us-east1.cockroachlabs.cloud:26257/defaultdb?options=--cluster%3Dnomad-realms-cluster-1145&sslmode=verify-full");
